...
$$End~depth_{i}= Middle~depth_{i} + \frac{Middle~depth_{i+1} - Middle~depth_{i}}{2}$$
For the first layer, the start depth is set as 0 and, for the last one, as the sampling depth.
